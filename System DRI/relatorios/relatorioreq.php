								...
								<div class="card mb-4">
									<div class="card-block">
										...
										<?php
											...
											$sql = "SELECT et, data, usuario, motivo, req FROM dados_wyntech WHERE req = '$req'";
											...
											if ($result->num_rows > 0) {
												...
												echo "<table>";
												echo "<tr><th>ET</th><th>Data</th><th>Usuário</th><th>Motivo</th><th>Req</th></tr>";
												while ($row = $result->fetch_assoc()) {
												echo "<tr><td>".$row['et']."</td><td>".$row['data']."</td><td>".$row['usuario']."</td><td>".$row['motivo']."</td><td>".$row['req']."</td></tr>";
												}
												echo "</table>";
												} else {
